...
from trainee_prn.action_items import DEATH_REPORT_ACTION, SUBJECT_OFFSTUDY_ACTION
...
class AddSubjectScreening(ContextMixin):
    ...
    def create_subject_screening_options(self):
        ...
        unpersisted trainee subject model instance.
        """
        options = dict(
...
class DashboardView(
    ...
    appointment_model = 'trainee_subject.appointment'
